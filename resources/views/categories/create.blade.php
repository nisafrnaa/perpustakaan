<x-app-layout>
    ...
    <div class="container mx-auto my-10">
        <div class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg p-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">Create New Category</h1>
            ...
            <form action="{{ route('categories.store') }}" method="POST">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded shadow hover:bg-blue-600">Create Category</button>
                </div>
            </form>
        </div>
    </div>
